...
void InitEPwm12Gpio(void)
{
    ...
    GpioCtrlRegs.GPAPUD.bit.GPIO23 = 1;    // Disable pull-up on GPIO168 (EPWM12B)
    ...
    GpioCtrlRegs.GPAGMUX2.bit.GPIO22 = 1;   // Configure GPIO20 as EPWM11A
    GpioCtrlRegs.GPAGMUX2.bit.GPIO23 = 1;   // Configure GPIO21 as EPWM11B
    GpioCtrlRegs.GPAMUX2.bit.GPIO22 = 1;   // Configure GPIO20 as EPWM11A
    GpioCtrlRegs.GPAMUX2.bit.GPIO23 = 1;   // Configure GPIO21 as EPWM11B
