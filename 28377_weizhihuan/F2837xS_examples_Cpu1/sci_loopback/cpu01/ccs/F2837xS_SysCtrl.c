...
void InitPeripheralClocks()
{
	...
	ClkCfgRegs.LOSPCP.bit.LSPCLKDIV = 1;           //  1/2
//	ClkCfgRegs.PERCLKDIVSEL.bit.EPWMCLKDIV = 1;    //  1/2

//	ClkCfgRegs.CLKSRCCTL3.bit.XCLKOUTSEL = 6;      //  Oscillator2
//	ClkCfgRegs.XCLKOUTDIVSEL.bit.XCLKOUTDIV = 0;   //  1
