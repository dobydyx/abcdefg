...
main2.obj: ../main2.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: "$<"'
	@echo 'Invoking: C2000 Compiler'
	"C:/ti/ccsv8/tools/compiler/ti-cgt-c2000_18.1.1.LTS/bin/cl2000" -v28 -ml -mt --float_support=fpu32 --tmu_support=tmu0 --vcu_support=vcu2 --cla_support=cla1 --include_path="C:/ti/ccsv8/tools/compiler/ti-cgt-c2000_18.1.1.LTS/include" --include_path="G:/CCSV8_WorkSpace/28377D_2/F2837xD_headers/include" --include_path="G:/CCSV8_WorkSpace/28377D_2/F2837xD_common/include" -g --define=CPU2 --diag_warning=225 --display_error_number --preproc_with_compile --preproc_dependency="main2.d_raw" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: "$<"'
	@echo ' '
