...
//! remote CPU. A GPIO input change on CPU01 causes an output change on CPU02 and 
//! vice versa. \n
...
// Spin here until CPU02 is ready
	...
	while(1)
	{
		// Generate a Square Wave on GPIO15. This signal will be used to drive GPIO14 input on CPU1
		if (count++ > 1000000)
		{
			count = 0;
			EALLOW;
