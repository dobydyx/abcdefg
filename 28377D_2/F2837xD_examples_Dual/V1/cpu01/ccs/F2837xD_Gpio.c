...
//	    GpioCtrlRegs.GPBDIR.bit.GPIO45 = 1;		//output as H_A                        GPIO6
        ...
        GPIO_SetupPinMux(45,GPIO_MUX_CPU2,0);
        GPIO_SetupPinOptions(45, GPIO_OUTPUT,0);
