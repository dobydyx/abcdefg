...
//	GPIO_SetupPinMux(84, GPIO_MUX_CPU1, 5);
	GpioCtrlRegs.GPCMUX2.bit.GPIO85 = 1;   // Configure GPIO9 for SCIRXDA operation
	GpioCtrlRegs.GPCGMUX2.bit.GPIO85 = 1;   // Configure GPIO8 for SCITXDA operation
	GpioCtrlRegs.GPCMUX2.bit.GPIO84 = 1;   // Configure GPIO9 for SCIRXDA operation
	GpioCtrlRegs.GPCGMUX2.bit.GPIO84 = 1;   // Configure GPIO8 for SCITXDA operation
