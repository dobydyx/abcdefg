...
MEMORY
{
 ...
 PAGE 1:    /* Data Memory */
   ...
   CANA          : origin = 0x048000, length = 0x000800		//个人分配，如有问题，注意修改       BY:Ezreal
   CANB          : origin = 0x04A000, length = 0x000800		//个人分配，如有问题，注意修改       BY:Ezreal
...
/*** PIE Vect Table and Boot ROM Variables Structures ***/
  UNION run = PIE_VECT, PAGE = 1
   ...
   CanaRegsFile          : > CANA,         PAGE = 1		//个人分配，如有问题，注意修改       BY:Ezreal
   CanbRegsFile          : > CANB,         PAGE = 1		//个人分配，如有问题，注意修改       BY:Ezreal
