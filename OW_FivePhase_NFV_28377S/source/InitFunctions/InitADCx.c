...
void LineCurSamp(float i[])
{
    ...
    ************************************************************/
    ...
    i[0] = __divf32(((int)AdcaResultRegs.ADCRESULT12 - 2000), 16.06274);  //IA1
    i[1] = __divf32(((int)AdcaResultRegs.ADCRESULT14 - 2000), 16.06274);  //IB1
    i[2] = __divf32(((int)AdccResultRegs.ADCRESULT12 - 2015), 16.06274);  //IC1    (RESULT - 2047.5[偏置]) / (4095 / 100[量程(-50A~50A)])
